...
exports.TransformOrigin = exports.cssExtend = exports.deepExtend = undefined;
...
var TransformOrigin = exports.TransformOrigin = function TransformOrigin(el) {
    if (!el || !el.style[_styleStuff2.default.CSS_TRANS_ORG]) {
        this.x = 0;
        this.y = 0;
        return;
    }
    var css = el.style[_styleStuff2.default.CSS_TRANS_ORG].split(' ');
