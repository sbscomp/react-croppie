...
var Croppie = function (_React$Component) {
    ...
    _createClass(Croppie, [{
        ...
        value: function render() {
            ...
            if (self.props.enableOrientation) preview = _react2.default.createElement(
                "canvas",
                { className: "cr-image", ref: "preview", style: this.state.previewStyle || {} },
                " "
            );else preview = _react2.default.createElement("img", { src: "", className: "cr-image", ref: "preview", style: this.state.previewStyle || {} });
            ...
            }, void 0, _react2.default.createElement("input", { type: "range",
                className: "cr-slider",
                step: "0.0001",
        ...
        value: function mouseDown(ev) {
            ...
            this.transform = _Transform.Transform.parse(this.refs.preview);
        ...
        value: function keyDown(ev) {
            ...
            if (ev.shiftKey && (ev.keyCode == UP_ARROW || ev.keyCode == DOWN_ARROW)) {
                ...
                self.transform = _Transform.Transform.parse(self.refs.preview);
                document.body.style[_styleStuff2.default.CSS_USERSELECT] = 'none';
        ...
        value: function changeZoom() {
            ...
            this._onZoom({
                ...
                origin: new _Transform.TransformOrigin(self.refs.preview),
                viewportRect: self.refs.viewport.getBoundingClientRect(),
                transform: _Transform.Transform.parse(self.refs.preview)
            });
        }
    }, {
        key: "mouseUp",
        ...
        value: function _setZoomerVal(v) {
            ...
            if (this.props.enableZoom) {
                var z = _reactDom2.default.findDOMNode(this.refs.zoomer);
        ...
        value: function _onZoom(ui) {
            var self = this;
            var transform = ui ? ui.transform : _Transform.Transform.parse(_reactDom2.default.findDOMNode(this.refs.preview));

            var //TODO does this need this.vpRect
            vpRect = ui ? ui.viewportRect : self.refs.elements.viewport.getBoundingClientRect();

            var origin = ui ? ui.origin : new _Transform.TransformOrigin(_reactDom2.default.findDOMNode(this.refs.preview));
            var transCss = {};
        ...
        value: function _updatePropertiesFromImage() {
            ...
            var transformReset = new _Transform.Transform(0, 0, initialZoom);
            var originReset = new _Transform.TransformOrigin();
        ...
        value: function _centerImage() {
            ...
            var transform = new _Transform.Transform(w, h, self._currentZoom);
        ...
        value: function _updateCenterPoint() {
            ...
            var transform = _Transform.Transform.parse(self.refs.preview.style[_styleStuff2.default.CSS_TRANSFORM]);
            var pc = new _Transform.TransformOrigin(self.refs.preview);
